...
class AEMOAuthAuthenticator {
  ...
  constructor(config: Partial<OAuthConfig> = {}) {
    this.config = {
      ...
      redirectUri: 'https://www.gradial.com/api/v1/auth/aem65/oauth2/callback',
      authorizationCode: config.authorizationCode,
      p12Path: '/Users/leeasling/Documents/GitHub/gradial-65/aem-cert.p12', //update this path to the location of your p12 file
